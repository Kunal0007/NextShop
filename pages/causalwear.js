...
const Causalwear = ({ products }) => {
  console.log(products);
  return (
    <div>
      <section className="text-gray-600 body-font">
        <div className="container px-7 sm:px-24 pb-7 mx-auto">
          <h1 className='text-center text-black font-bold text-3xl my-10'>Causalwear</h1>
                ...
                <Link key={item._id} href={`/product/${item.slug}`}>
                  <div className="lg:w-1/5 md:w-1/3 m-2 p-4 w-full shadow-md cursor-pointer">
                    <a className="block relative rounded overflow-hidden">
                      <img alt="ecommerce" className="object-cover object-center w-full shadow-md h-full block" src={item.img} />
                    </a>
                    <div className="mt-4">
