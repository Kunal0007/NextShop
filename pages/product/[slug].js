                    ...
                    <div className="lg:w-4/5 mx-auto flex flex-wrap">
                        ...
                        <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                            ...
                            <div className="flex border-b-2 border-gray-100 mb-5 pb-5">
                                ...
                                <button onClick={() => { buyNow(slug, `${product.title}(${product.color}/${product.size})`, product.price, 1) }} className="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">BUY NOW </button>
                                <button onClick={() => { addtoCart(slug, `${product.title}(${product.color}/${product.size})`, product.price, 1) }} className="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">Add to Cart</button>
