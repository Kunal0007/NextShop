            ...
            <section className="text-gray-600 body-font overflow-hidden">
                <div className="container px-5 py-24 mx-auto">
                    <div className="lg:w-4/5 mx-auto flex flex-wrap">
                        <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto h-64 object-scale-down object-center rounded" src="https://rukminim1.flixcart.com/image/832/832/l2arp8w0/t-shirt/c/w/9/xs-tlorrn-d45-tripr-original-imagdzex5gg6dahf.jpeg?q=70" />
                            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                                ...
                                <div className="flex border-b-2 border-gray-100 mb-5 pb-5">
                                    ...
                                    <button onClick={() => {addtoCart(slug, 'T-shirts', 499, 1)}} className="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">Add to Cart</button>
